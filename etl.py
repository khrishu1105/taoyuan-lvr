...
REDEV_ZONES = {
 "青埔A18高鐵站":   {"c":[25.0137,121.2141],"segs":["青平段","青埔段","青昇段"]},
 "青埔A19體育園區":  {"c":[25.0017,121.2033],"segs":["啟文段","青塘段"]},
 "青埔A17領航站":   {"c":[25.0241,121.2211],"segs":["青山段","青芝段"]},
 "中路重劃區":       {"c":[24.9919,121.2863],"segs":["中路段","中路二段","中路三段"]},
 "小檜溪重劃區":     {"c":[25.0014,121.3064],"segs":["三民段"]},
 "經國重劃區":       {"c":[25.0250,121.2955],"segs":["水汴頭段","龍祥段"]},
 "藝文特區":         {"c":[25.0172,121.2996],"segs":["同安段","中埔段"]},
 "大有/龍安":        {"c":[25.0044,121.3227],"segs":["大有段","忠義段"]},
 "桃園站前":         {"c":[24.9893,121.3136],"segs":["東門段"]},
 "航空城客運園區":   {"c":[25.0555,121.1975],"segs":["客運一段","客運二段","客運三段"]},
 "中壢站前A22":      {"c":[24.9533,121.2262],"segs":["豐興段"]},
 "中壢青溪":         {"c":[24.9620,121.2360],"segs":["青溪段"]},
 "龜山機捷A7":       {"c":[25.0398,121.3814],"segs":["善捷段","樂捷段"]},
 "蘆竹南崁":         {"c":[25.0357,121.2995],"segs":["上興段","新鼻段","大新段"]},
 "八德擴大重劃":     {"c":[24.9287,121.2847],"segs":["興仁段","明智段"]},
