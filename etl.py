...
REDEV_ZONES = {
 # 青埔(高鐵特區)依老街溪(至善路)/青昇路分：青昇路東=A17、老街溪東=A18、老街溪西=A19
 "青埔A17領航站":   {"c":[25.0214,121.2209],"segs":["青峰段"]},  # 青峰里/領航北路四段(大園北端)
 "青埔A18高鐵站":   {"c":[25.0137,121.2141],"segs":["青平段","青昇段","青埔段","青山段"]},
 "青埔A19體育園區":  {"c":[24.9990,121.2130],"segs":["青芝段","青塘段","青溪段"]},  # 西南鄰中壢(領航北路一段/洽溪里)
 # 中壢機捷/市區
 "A20興南":         {"c":[24.9802,121.2165],"segs":["豐興段"]},
 "中壢站前A22":      {"c":[24.9533,121.2262],"segs":["三座屋段三座屋小段","三座屋段舊社小段"]},
 "內壢元生":         {"c":[24.9660,121.2560],"segs":["忠孝段"]},
 # 桃園區
